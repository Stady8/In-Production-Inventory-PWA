...
Possible inventory system for a local fire department. The website is a progressive web app which allows it to work on a laptop or saved as an web app on a mobile deivce. I've added two ejs files for preview of code.
